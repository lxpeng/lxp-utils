...
public class VeDate {
     ...
     */
    public static String getStringDateShort_2() {
        Date currentTime = new Date();
     ...
     * @return 获取当月有共有多少天
     */
    public static String getDayCount(String dat) {// yyyy-MM-dd
        String str = "";
        String month = dat.substring(5, 7);
        int mon = Integer.parseInt(month);
        if (mon == 1 || mon == 3 || mon == 5 || mon == 7 || mon == 8 || mon == 10 || mon == 12) {
    ...
    public static int[] getTimeS(Date date) {
        ...
        times[0] = Integer.parseInt(s[0]);
        times[1] = Integer.parseInt(s[1]);
        times[2] = Integer.parseInt(s[2]);
        return times;
    }
     ...
     * @return //将/m/转换为/mm/
     */
    public static String changeToString(String date) {
        if (date.length() == 1) {
            return "0" + date;
        } else {
            return date;
    ...
    /**
     * @param date yyyy/mm/rr
     * @return 将yyyy/mm/rr转换为yyyy-mm-rr
     */
    ...
    /**
     * 输入yyyy-mm-rr hh:mm 转换为 yyyy-mm-rr 上午/下午 hh:mm
     *
     * @param time yyyy-mm-rr hh:mm
     * @return 输入yyyy-mm-rr hh:mm 转换为 yyyy-mm-rr 上午/下午 hh:mm
     */
    public static String get12CustomTime(String time) {
        String tiemString = "";
        time = time.trim();
        tiemString += time.substring(0, 10);
        int h = Integer.parseInt(time.substring(11, 13));
        if (h > 12) {
            String hStr = (h - 12) < 10 ? "0" + (h - 12) : (h + "");
            tiemString += "  下午  " + hStr;
        } else {
            if (h == 12) {
                tiemString += "  下午  " + h;
        ...
        tiemString += time.substring(13, 16);
        return tiemString;
    }
